...
from shell_helper import GitlabApiHelper
import glob
...
def add_all_reports(db, cdr_id, pip_id, gitsha, report_dir):
    ...
    for report in reports:
        ...
        db.add_file_report(cdr_id, pip_id, gitsha, reportkey, redict)
...
if __name__ == "__main__":
    ...
    add_all_reports(db, args.cdr_id, gitlab.get_pipeline_id(), args.gitsha, args.report_dir)